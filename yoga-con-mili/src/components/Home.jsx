  ...
  return (
    <div className="animate-slide-up">
      ...
      <section className="relative overflow-hidden bg-linen">
        {/* Placeholder imagen hero — reemplazar con NanoBanana2 */}
        <div className="h-72 bg-gradient-to-b from-beige to-linen flex items-end justify-center">
          <div className="w-full h-full bg-[url('/assets/hero-placeholder.jpg')] bg-cover bg-center opacity-40 absolute inset-0" />
          <div className="relative z-10 text-center pb-8 px-6">
            <p className="section-subtitle mb-2">bienvenida a tu espacio</p>
            <h1 className="font-serif text-4xl text-deep-green leading-tight">
              Yoga<br />
              <em className="text-driftwood">con Mili</em>
            </h1>
          </div>
        </div>
